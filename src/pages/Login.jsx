...
const Login = ({ setIsAdmin }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    // Admin credentials
    const adminEmail = 'mpanchadi@gmail.com';
    const adminPassword = '1606';
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-600 via-purple-600 to-indigo-800 flex items-center justify-center py-12 px-4">
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">Access the admin dashboard to manage content</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <motion.button
            type="submit"
            disabled={loading}
            className="w-full bg-gradient-to-r from-blue-600 to-purple-600 text-white py-3 rounded-lg font-semibold hover:from-blue-700 hover:to-purple-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200"
